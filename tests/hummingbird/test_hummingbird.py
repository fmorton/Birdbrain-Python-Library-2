...
def test_acceleration_with_alias():
    ...
    response = hummingbird.acceleration()
    response = hummingbird.getAcceleration()
...
def test_compass_with_alias():
    ...
    response = hummingbird.compass()
    response = hummingbird.getCompass()
...
def test_magnetometer_with_alias():
    ...
    response = hummingbird.magnetometer()
